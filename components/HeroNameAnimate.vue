...
<template>
  ...
  >
    <p>Meet 
        <span class="underline decoration-blue-500 underline-offset-4">Milan</span> Herbé from
        <span class="text-blue-400 italic">Fr</span>
      <span class="text-gray-50 italic">an</span>
      <span class="text-red-400 italic">ce</span>
    </p>
  </div>
</template>